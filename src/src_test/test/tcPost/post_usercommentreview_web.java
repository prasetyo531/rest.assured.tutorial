...
public class post_usercommentreview_web extends base{
...
//        Assert.assertNotNull(response_token);
    ...
    cek table nubr_reviewer
    cek nubr comment
    pk rvwr_id
     */
    @Test(priority = 2)
    public void postusercommentreview_web() {
        ...
        // Create new JSON Object
        JsonObject loginCredentials = new JsonObject();
        loginCredentials.addProperty("type", "review");
        loginCredentials.addProperty("object_id", "645518");
