...
public class get_userProfile_web extends base {
    ...
    public void run_post_login() {
        ...
        loginCredentials.addProperty("password", "123tester");
...
//        //tc_get body branch
        Integer response_usrapo_id = res.path("data.usrapo_id");
        System.out.println(response_usrapo_id);

        Assert.assertNotSame(response_usrapo_id,null);
